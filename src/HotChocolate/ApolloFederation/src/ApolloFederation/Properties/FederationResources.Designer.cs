...
namespace HotChocolate.ApolloFederation.Properties {
    ...
    internal class FederationResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to @shareable directive.
        /// </summary>
        internal static string Feature_Shareable {
            get {
                return ResourceManager.GetString("Feature_Shareable", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Value connot be null or empty..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Indicates that a definition in the subgraph schema should be omitted from the router&apos;s API schema, even if that definition is also present in other subgraphs. This means that the field is not exposed to clients at all..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Indicates that an object field is now resolved by this subgraph instead of another subgraph where it&apos;s also defined. This enables you to migrate a field from one subgraph to another..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Indicates that an object type&apos;s field is allowed to be resolved by multiple subgraphs (by default in Federation 2, object fields can be resolved by only one subgraph)..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Federation version of &quot;Minimum&quot; is invalid in this context..
        /// </summary>
        internal static string ThrowHelper_Minimum_Version_Invalid {
            get {
                return ResourceManager.GetString("ThrowHelper_Minimum_Version_Invalid", resourceCulture);
            }
        }
